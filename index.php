    ...
    $row = mysqli_fetch_assoc($res);
        ...
        if($email == isset($row['Email'])) //check email apc_exists(keys)
        {
         echo "email already exists";
            ...
            // Insert
      $insert="INSERT INTO `Student`(`FirstName`,`LastName`, `Email`, `Phone`, `Password`,`profilepic`,`Resume`,`Birthdate`,`Gender`,`Address`,`State`,`City`,`Category`) VALUES ('$fname', '$lname','$email','$phone','$hash','$propic','$resume','$birthdate','$gender','$address','$state','$city','$category');";
